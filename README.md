...
*[Skyward Insights](https://github.com/KarimMAJDOUB/Skyward-Insights)*|![25%](https://progress-bar.dev/5)|Data pipeline and analysis to extracts flight data from flights APIs and constructs a dashboard on top of this|`Data Engineering`,`DataViz`,`Data Analysis`,`Apache Airflow`,`Power BI`|
